...
describe("useRelatedProductsService", () => {
  ...
  it("should refetch when currentProductId changes", async () => {
    ...
    const { result, rerender } = renderHook(({ productId }) => useRelatedProductsService(productId), {
  ...
  it("should refetch when limit changes", async () => {
    ...
    const { result, rerender } = renderHook(({ productId, limit }) => useRelatedProductsService(productId, limit), {
