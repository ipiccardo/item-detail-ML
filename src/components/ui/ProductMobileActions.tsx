    ...
    return (
        <div className="lg:hidden mb-4">
            ...
            <div className="space-y-2 mb-4">
                <button
                    onClick={onBuyNow}
                    className="w-full bg-blue-600 text-white text-sm font-medium py-3 px-4 rounded-md
                ...
                <button
                    onClick={onAddToCart}
                    className="w-full bg-blue-100 text-blue-600 text-sm font-medium py-3 px-4 rounded-md
